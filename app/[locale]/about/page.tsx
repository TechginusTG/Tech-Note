  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div ref={founderRef} className={`${styles.animatedSection} ${founderIsVisible ? styles.isVisible : ''}`}>
        <h2 className="text-3xl font-bold text-center mb-8">{t('founder_title')}</h2>
        <div className="flex flex-col items-center text-center mb-12">
          <img src="https://via.placeholder.com/150" alt="Founder" className="w-40 h-40 rounded-full mb-4" />
